...
\begin{equation}
\begin{split}
\Pr(a_t=j\mid s_t, x_t) &= \Pr(v_j+\varepsilon(j)>v_k+\varepsilon(k), k\neq j\mid s_t, x_t)\\
...
The replication code is available on \href{https://github.com/Yin-Yun-Li/labor-econ/blob/main/Code/DDC.jl}{GitHub}.
